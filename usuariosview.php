...
class cusuarios_view extends cusuarios {
	...
	function __construct() {
		...
		$KeyUrl = "";
		if (@$_GET["usuario"] <> "") {
			$this->RecKey["usuario"] = $_GET["usuario"];
			$KeyUrl .= "&usuario=" . urlencode($this->RecKey["usuario"]);
		}
	...
	function Page_Init() {
		...
		if (@$_GET["usuario"] <> "") {
			...
			$gsExportFile .= ew_StripSlashes($_GET["usuario"]);
		}
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["usuario"] <> "") {
				...
				$this->RecKey["usuario"] = $this->usuario->QueryStringValue;
			} else {
...
<?php if ($usuarios->contra->Visible) { // contra ?>
	<tr id="r_contra"<?php echo $usuarios->RowAttributes() ?>>
		<td><span id="elh_usuarios_contra"><?php echo $usuarios->contra->FldCaption() ?></span></td>
...
<?php echo $usuarios->contra->ViewValue ?></span>
</span></td>
	</tr>
<?php } ?>
<?php if ($usuarios->tipo_usuario->Visible) { // tipo_usuario ?>
	<tr id="r_tipo_usuario"<?php echo $usuarios->RowAttributes() ?>>
		<td><span id="elh_usuarios_tipo_usuario"><?php echo $usuarios->tipo_usuario->FldCaption() ?></span></td>
...
<?php echo $usuarios->tipo_usuario->ViewValue ?></span>
</span></td>
	</tr>
<?php } ?>
</table>
