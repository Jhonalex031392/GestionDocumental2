...
$seguimiento_view = NULL; // Initialize page object first

class cseguimiento_view extends cseguimiento {
	...
	// Page object name
	var $PageObjName = 'seguimiento_view';
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["numero"] <> "") {
				...
				$sReturnUrl = "seguimientolist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "seguimientolist.php"; // No matching record, return to list
					}
			}
			...
			$sReturnUrl = "seguimientolist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
	...
	function SetupExportOptions() {
		...
		$item->Body = "<a id=\"emf_seguimiento\" href=\"javascript:void(0);\" class=\"ewExportLink ewEmail\" data-caption=\"" . $Language->Phrase("ExportToEmailText") . "\" onclick=\"ew_EmailDialogShow({lnk:'emf_seguimiento',hdr:ewLanguage.Phrase('ExportToEmail'),f:document.fseguimientoview,key:" . ew_ArrayToJsonAttr($this->RecKey) . ",sel:false});\">" . $Language->Phrase("ExportToEmail") . "</a>";
		$item->Visible = TRUE;
...
// Create page object
if (!isset($seguimiento_view)) $seguimiento_view = new cseguimiento_view();

// Page init
$seguimiento_view->Page_Init();

// Page main
$seguimiento_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$seguimiento_view->Page_Render();
?>
...
// Page object
var seguimiento_view = new ew_Page("seguimiento_view");
seguimiento_view.PageID = "view"; // Page ID
var EW_PAGE_ID = seguimiento_view.PageID; // For backward compatibility

// Form object
var fseguimientoview = new ew_Form("fseguimientoview");

// Form_CustomValidate event
fseguimientoview.Form_CustomValidate = 
...
fseguimientoview.ValidateRequired = true;
<?php } else { ?>
fseguimientoview.ValidateRequired = false; 
<?php } ?>
...
<?php $seguimiento_view->ExportOptions->Render("body") ?>
<?php if (!$seguimiento_view->ExportOptions->UseDropDownButton) { ?>
</div>
<div class="ewViewOtherOptions">
<?php } ?>
<?php
	foreach ($seguimiento_view->OtherOptions as &$option)
		$option->Render("body");
?>
</div>
<?php } ?>
<?php $seguimiento_view->ShowPageHeader(); ?>
<?php
$seguimiento_view->ShowMessage();
?>
<form name="fseguimientoview" id="fseguimientoview" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="seguimiento">
<table cellspacing="0" class="ewGrid"><tr><td>
<table id="tbl_seguimientoview" class="table table-bordered table-striped">
...
<?php echo $seguimiento->numero->ViewValue ?></span>
</span></td>
	</tr>
<?php } ?>
...
<?php echo $seguimiento->radicado->ViewValue ?></span>
</span></td>
	</tr>
<?php } ?>
...
<?php echo $seguimiento->fecha->ViewValue ?></span>
</span></td>
	</tr>
<?php } ?>
...
<?php echo $seguimiento->hora->ViewValue ?></span>
</span></td>
	</tr>
<?php } ?>
...
<?php echo $seguimiento->dependencia->ViewValue ?></span>
</span></td>
	</tr>
<?php } ?>
</table>
...
<script type="text/javascript">
fseguimientoview.Init();
</script>
<?php
$seguimiento_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<?php if ($seguimiento->Export == "") { ?>
...
<?php
$seguimiento_view->Page_Terminate();
?>
