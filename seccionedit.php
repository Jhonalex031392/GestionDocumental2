...
$seccion_edit = NULL; // Initialize page object first

class cseccion_edit extends cseccion {
	...
	function Page_Main() {
		...
		// Check if valid key
		if ($this->codigo_seccion->CurrentValue == "")
			$this->Page_Terminate("seccionlist.php"); // Invalid key, return to list
	...
	function RenderRow() {
		...
		if ($this->RowType == EW_ROWTYPE_VIEW) { // View row
			...
			$this->codigo_seccion->EditValue = $this->codigo_seccion->CurrentValue;
			$this->codigo_seccion->ViewCustomAttributes = "";
	...
	function EditRow() {
		...
		if ($rs->EOF) {
			...
			// nombre_seccion
			$this->nombre_seccion->SetDbValueDef($rsnew, $this->nombre_seccion->CurrentValue, NULL, $this->nombre_seccion->ReadOnly);
...
// Create page object
if (!isset($seccion_edit)) $seccion_edit = new cseccion_edit();

// Page init
$seccion_edit->Page_Init();

// Page main
$seccion_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$seccion_edit->Page_Render();
?>
<?php include_once "header.php" ?>
<script type="text/javascript">

// Page object
var seccion_edit = new ew_Page("seccion_edit");
seccion_edit.PageID = "edit"; // Page ID
var EW_PAGE_ID = seccion_edit.PageID; // For backward compatibility

// Form object
var fseccionedit = new ew_Form("fseccionedit");

// Validate form
fseccionedit.Validate = function() {
...
fseccionedit.Form_CustomValidate = 
...
fseccionedit.ValidateRequired = true;
<?php } else { ?>
fseccionedit.ValidateRequired = false; 
<?php } ?>
...
<?php $seccion_edit->ShowPageHeader(); ?>
<?php
$seccion_edit->ShowMessage();
?>
<form name="fseccionedit" id="fseccionedit" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="seccion">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<table cellspacing="0" class="ewGrid"><tr><td>
<table id="tbl_seccionedit" class="table table-bordered table-striped">
...
<?php echo $seccion->codigo_seccion->EditValue ?></span>
<input type="hidden" data-field="x_codigo_seccion" name="x_codigo_seccion" id="x_codigo_seccion" value="<?php echo ew_HtmlEncode($seccion->codigo_seccion->CurrentValue) ?>">
