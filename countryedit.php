...
// Form object
var fcountryedit = new ew_Form("fcountryedit");
...
?>
<form name="fcountryedit" id="fcountryedit" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="country">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<table cellspacing="0" class="ewGrid"><tr><td>
<table id="tbl_countryedit" class="table table-bordered table-striped">
...
<?php echo $country->Code->EditValue ?></span>
<input type="hidden" data-field="x_Code" name="x_Code" id="x_Code" value="<?php echo ew_HtmlEncode($country->Code->CurrentValue) ?>">
