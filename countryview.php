...
class ccountry_view extends ccountry {
	...
	function Page_Init() {
		...
		if (@$_GET["Code"] <> "") {
			...
			$gsExportFile .= ew_StripSlashes($_GET["Code"]);
		}
	...
	function SetupExportOptions() {
		...
		$item->Body = "<a id=\"emf_country\" href=\"javascript:void(0);\" class=\"ewExportLink ewEmail\" data-caption=\"" . $Language->Phrase("ExportToEmailText") . "\" onclick=\"ew_EmailDialogShow({lnk:'emf_country',hdr:ewLanguage.Phrase('ExportToEmail'),f:document.fcountryview,key:" . ew_ArrayToJsonAttr($this->RecKey) . ",sel:false});\">" . $Language->Phrase("ExportToEmail") . "</a>";
		$item->Visible = TRUE;
...
// Form object
var fcountryview = new ew_Form("fcountryview");
...
<?php if (!$country_view->ExportOptions->UseDropDownButton) { ?>
</div>
...
?>
<form name="fcountryview" id="fcountryview" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="country">
<table cellspacing="0" class="ewGrid"><tr><td>
<table id="tbl_countryview" class="table table-bordered table-striped">
...
<?php echo $country->Capital->ViewValue ?></span>
</span></td>
	</tr>
<?php } ?>
...
<?php echo $country->Province->ViewValue ?></span>
</span></td>
	</tr>
<?php } ?>
</table>
