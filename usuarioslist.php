...
class cusuarios_list extends cusuarios {
	...
	function SetupKeyValues($key) {
		...
		if (count($arrKeyFlds) >= 1) {
			$this->usuario->setFormValue($arrKeyFlds[0]);
		}
		return TRUE;
	}
	...
	function BasicSearchSQL($Keyword) {
		...
		$this->BuildBasicSearchSQL($sWhere, $this->contra, $Keyword);
		return $sWhere;
	}
	...
	function SetUpSortOrder() {
		...
		if (@$_GET["order"] <> "") {
			...
			$this->UpdateSort($this->contra); // contra
...
<?php if ($usuarios->contra->Visible) { // contra ?>
	<?php if ($usuarios->SortUrl($usuarios->contra) == "") { ?>
		<td><div id="elh_usuarios_contra" class="usuarios_contra"><div class="ewTableHeaderCaption"><?php echo $usuarios->contra->FldCaption() ?></div></div></td>
	<?php } else { ?>
		<td><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $usuarios->SortUrl($usuarios->contra) ?>',1);"><div id="elh_usuarios_contra" class="usuarios_contra">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $usuarios->contra->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($usuarios->contra->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($usuarios->contra->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></td>
	<?php } ?>
<?php } ?>		
<?php if ($usuarios->tipo_usuario->Visible) { // tipo_usuario ?>
	<?php if ($usuarios->SortUrl($usuarios->tipo_usuario) == "") { ?>
		<td><div id="elh_usuarios_tipo_usuario" class="usuarios_tipo_usuario"><div class="ewTableHeaderCaption"><?php echo $usuarios->tipo_usuario->FldCaption() ?></div></div></td>
	<?php } else { ?>
		<td><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $usuarios->SortUrl($usuarios->tipo_usuario) ?>',1);"><div id="elh_usuarios_tipo_usuario" class="usuarios_tipo_usuario">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $usuarios->tipo_usuario->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($usuarios->tipo_usuario->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($usuarios->tipo_usuario->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></td>
	<?php } ?>
<?php } ?>		
<?php
...
?>
	<?php if ($usuarios->usuario->Visible) { // usuario ?>
		<td<?php echo $usuarios->usuario->CellAttributes() ?>><span id="el<?php echo $usuarios_list->RowCnt ?>_usuarios_usuario" class="control-group usuarios_usuario">
<span<?php echo $usuarios->usuario->ViewAttributes() ?>>
<?php echo $usuarios->usuario->ListViewValue() ?></span>
</span><a id="<?php echo $usuarios_list->PageObjName . "_row_" . $usuarios_list->RowCnt ?>"></a></td>
	<?php } ?>
	<?php if ($usuarios->contra->Visible) { // contra ?>
		<td<?php echo $usuarios->contra->CellAttributes() ?>><span id="el<?php echo $usuarios_list->RowCnt ?>_usuarios_contra" class="control-group usuarios_contra">
<span<?php echo $usuarios->contra->ViewAttributes() ?>>
<?php echo $usuarios->contra->ListViewValue() ?></span>
</span><a id="<?php echo $usuarios_list->PageObjName . "_row_" . $usuarios_list->RowCnt ?>"></a></td>
	<?php } ?>
	<?php if ($usuarios->tipo_usuario->Visible) { // tipo_usuario ?>
		<td<?php echo $usuarios->tipo_usuario->CellAttributes() ?>><span id="el<?php echo $usuarios_list->RowCnt ?>_usuarios_tipo_usuario" class="control-group usuarios_tipo_usuario">
<span<?php echo $usuarios->tipo_usuario->ViewAttributes() ?>>
<?php echo $usuarios->tipo_usuario->ListViewValue() ?></span>
</span><a id="<?php echo $usuarios_list->PageObjName . "_row_" . $usuarios_list->RowCnt ?>"></a></td>
	<?php } ?>
<?php
...
<!--first page button-->
	...
	<a class="btn btn-small" type="button" href="<?php echo $usuarios_list->PageUrl() ?>start=<?php echo $usuarios_list->Pager->FirstButton->Start ?>"><i class="icon-step-backward"></i></a>
	<?php } else { ?>
...
<!--previous page button-->
	...
	<a class="btn btn-small" type="button" href="<?php echo $usuarios_list->PageUrl() ?>start=<?php echo $usuarios_list->Pager->PrevButton->Start ?>"><i class="icon-prev"></i></a>
	<?php } else { ?>
...
<!--next page button-->
	...
	<a class="btn btn-small" type="button" href="<?php echo $usuarios_list->PageUrl() ?>start=<?php echo $usuarios_list->Pager->NextButton->Start ?>"><i class="icon-play"></i></a>
	<?php } else { ?>
	<a class="btn btn-small" type="button" disabled="disabled"><i class="icon-play"></i></a>
	<?php } ?>
<!--last page button-->
	<?php if ($usuarios_list->Pager->LastButton->Enabled) { ?>
	<a class="btn btn-small" type="button" href="<?php echo $usuarios_list->PageUrl() ?>start=<?php echo $usuarios_list->Pager->LastButton->Start ?>"><i class="icon-step-forward"></i></a>
	<?php } else { ?>
