...
class cdefault {
	...
	function Page_Main() {
		...
		$this->Page_Terminate("citylist.php"); // Exit and go to default page
		if ($Security->IsLoggedIn())
			$this->Page_Terminate("clasedocumentolist.php");
		if ($Security->IsLoggedIn())
			$this->Page_Terminate("countrylist.php");
		if ($Security->IsLoggedIn())
			$this->Page_Terminate("entradalist.php");
		if ($Security->IsLoggedIn())
			$this->Page_Terminate("locatedlist.php");
		if ($Security->IsLoggedIn())
			$this->Page_Terminate("provincelist.php");
		if ($Security->IsLoggedIn())
			$this->Page_Terminate("sedelist.php");
		if ($Security->IsLoggedIn())
			$this->Page_Terminate("seguimientolist.php");
		if ($Security->IsLoggedIn())
			$this->Page_Terminate("usuarioslist.php");
		if ($Security->IsLoggedIn())
			$this->Page_Terminate("seccionlist.php");
		if ($Security->IsLoggedIn())
			$this->Page_Terminate("subseccionlist.php");
		if ($Security->IsLoggedIn()) {
