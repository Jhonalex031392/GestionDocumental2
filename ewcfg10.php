...
define("EW_PROJECT_ID", "{D74DC9FA-763C-48C4-880F-6C317035A0C2}", TRUE); // Project ID (GUID)
$EW_RELATED_PROJECT_ID = "";
$EW_RELATED_LANGUAGE_FOLDER = "";
define("EW_RANDOM_KEY", 'TQ5iV9kegmCYU145', TRUE); // Random key for encryption
...
define("EW_CONN_DB", 'gestiond', TRUE);
...
define("EW_UPLOAD_ALLOWED_FILE_EXT", "gif,jpg,jpeg,bmp,png,doc,xls,pdf,zip,xlsx,txt,docx", TRUE); // Allowed file extensions
