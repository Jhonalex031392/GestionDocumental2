...
?>
<form name="fcityedit" id="fcityedit" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
...
<?php echo $city->Name->EditValue ?></span>
<input type="hidden" data-field="x_Name" name="x_Name" id="x_Name" value="<?php echo ew_HtmlEncode($city->Name->CurrentValue) ?>">
...
<?php echo $city->Country->EditValue ?></span>
<input type="hidden" data-field="x_Country" name="x_Country" id="x_Country" value="<?php echo ew_HtmlEncode($city->Country->CurrentValue) ?>">
...
<?php echo $city->Province->EditValue ?></span>
<input type="hidden" data-field="x_Province" name="x_Province" id="x_Province" value="<?php echo ew_HtmlEncode($city->Province->CurrentValue) ?>">
